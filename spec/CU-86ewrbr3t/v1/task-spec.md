...
- [ ] Fields: `ID` (string), `Version` (int64), `CreatedAt` (string), `Description` (string), `DockerReference` (string), `DockerTag` (string)
...
- Zinc registry must provide ResolverVersionPrincipalResp with dockerReference and dockerTag
